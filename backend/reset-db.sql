...
VALUES ('Pedro', 'pedro@email.com', 'apero'),
('Adrien', 'adrien@email.com', 'monoceros'),
('John', 'john@email.com', 'reykjavik');

INSERT INTO `Tweet` (author, content)
VALUES ('John', 'Bienvenue sur Wikit Tweet !'),
('Pedro', "Apéro ?" ),
...
('John', "Petit conseil: Mieux vaut ne rien dire et passer pour un con que l'ouvrir et ne laisser aucun doute à ce sujet !"),
...
('John', "Qu'importe le flacon, tant qu'on a l'ivresse !"),
